...
import 'package:otex_app_test/core/text_styling/factory/i_typography_factory.dart';
import 'package:otex_app_test/core/text_styling/factory/typography_factory_provider.dart';
import 'package:otex_app_test/core/text_styling/semantics/semantic_text_styles.dart';
import 'package:otex_app_test/core/text_styling/tokens/app_font_weights.dart';
...
import 'package:otex_app_test/core/theme_manager/tokens/colors_tokens.dart';
...
class AppThemeFactory implements IAppThemeFactory {
  ...
  SemanticColors _lightSemantic() {
    return const SemanticColors(
      ...
      grayOpacity10: ColorTokensLight.grayOpacity10,
      grayOpacity5: ColorTokensLight.grayOpacity5,
      darkOrange: ColorTokensLight.darkOrange,
      borderGray: ColorTokensLight.borderGray,
      whiteOrange: ColorTokensLight.whiteOrange,
      gray: ColorTokensLight.gray,
      black: ColorTokensLight.black,
      green: ColorTokensLight.green,
      red: ColorTokensLight.red,
      blue: ColorTokensLight.blue,
      whiteBlue: ColorTokensLight.whiteBlue,
      purple: ColorTokensLight.purple,
    );
  }
  ...
  SemanticColors _darkSemantic() {
    return const SemanticColors(
      ...
      grayOpacity10: ColorTokensDark.primary3,
      grayOpacity5: ColorTokensDark.primary4,
      darkOrange: ColorTokensDark.primary5,
      borderGray: ColorTokensDark.primary6,
      whiteOrange: ColorTokensDark.primary7,
      gray: ColorTokensDark.primary8,
      black: ColorTokensDark.primary9,
      green: ColorTokensDark.green,
      red: ColorTokensDark.red,
      blue: ColorTokensDark.blue,
      whiteBlue: ColorTokensDark.whiteBlue,
      purple: ColorTokensDark.purple,
    );
  }
